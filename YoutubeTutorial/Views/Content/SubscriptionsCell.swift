...
internal class SubscriptionsCell: BaseCell {
    // MARK: UI Components
        ...
        NetworkManager.shared.fetchEndPointPublisher([Video].self, from: .subscriptions)
            ...
            .sink { completion in
                ...
                case let .failure(error):
                    print("Subscriptions Cell Error: \(error.localizedDescription)")
                case .finished:
                    break
                }
...
extension SubscriptionsCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
