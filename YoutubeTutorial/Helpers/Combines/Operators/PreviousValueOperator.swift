//
//  PreviousValueOperator.swift
//  YoutubeTutorial
//
//  Created by Dimas Prabowo on 20/02/23.
//
...
extension Publisher {
    ...
    internal func withPrevious() -> AnyPublisher<(previous: Output?, current: Output), Failure> {
    ...
    /// - Returns: A publisher of a tuple of the previous and current elements from the upstream publisher.
    internal func withPrevious(_ initialPreviousValue: Output) -> AnyPublisher<(previous: Output, current: Output), Failure> {
